...
const categoryItems = [
  ...
  },
  {
    id: 3,
    title: "Dessert",
    description: "(48 dishes)",
    image: "/images/home/category/img3.png",
  },
  {
    id: 4,
    title: "Browse All",
    description: "(255 dishes)",
    ...
    <div className="section-container py-16">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-8 justify-around items-center mt-12 ">
        {categoryItems.map((item, i) => (
          <div
            key={i}
            className="shadow-lg rounded-md bg-white py-6 px-4 w-60 mx-auto text-center cursor-pointer hover:-translate-y-4 transition-all duration-300 z-10"
          >
